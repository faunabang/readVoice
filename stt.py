    ...
    def req_upload(self, file, completion, callback=None, userdata=None, forbiddens=None, boostings=None,
        ...
        request_body = {
            ...
            "keywordBoosting": {
                ...
                {
                    # 장소
                    "words": "제주과학고등학교, 제주과학고, 제주과고, 과학고, 과고, 제곽, 1층 교무실, 2층 교무실, 간식실, 강당, 기숙사, 노래방, 도서관, 도서관 스터디룸, 물리실험실, 무한상상실, 면학실, 멀미실, 멀티미디어실, 배지실, 생물실험실, 수학실, 연구동, VR 체험실, 전문 기자재실, 지구과학실, 체력단련실, 체육관, 학생활동실, 화학실험실, 행정실, 회의실",
                    "weight": 3 # 0~5, 0은 미적용
                },
                {
                    # 선생님
